...
struct AzureTranslator {
    static public func translateFromAzure(_ word: String) {
    ...
    static func translate(_ word: String, completionHandler: @escaping (_ translation: String) -> Void) {
        ...
        let task = session.dataTask(with: request, completionHandler: { responseData, response, responseError in
            ...
            if let responseData = responseData {
                let langTranslations = try? jsonDecoder.decode(Array<ReturnedJson>.self, from: responseData)
