...
public class GBig {
    ...
    //  try to opt, failed now (make a dict, not always use firstIndex which is N(o)
//    static var s2tDict: Dictionary<String, String> {
//        var result: Dictionary<String, String> = Dictionary()
//        for s in gb {
//            if let i = gb.firstIndex(of: s) {
//                result[String(s)] = big5[i]
//            } else {
