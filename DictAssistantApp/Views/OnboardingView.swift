            ...
            content: {
                ...
                if showPlaying {
                    VStack(alignment: .leading) {
                        ...
                        Text("The cropper window has an animation stoke border. The cropper area is the area where the English text recorded in screen you want to be recognized, the content area is the area where you want to locate the corresponding unknown words translation.")
                            .frame(height: 45)
                            .font(.subheadline)
                        Text("Step 2: Press the shortcut key again and playing.")
                        Text("Need Screen Recording Permission First time. The App it self is excluded from screen capture. If there is nothing displayed, usually it means there is no unknown words currently, it depends on your vocabulary.")
                            .frame(height: 45)
                            .font(.subheadline)
                        Divider()
                        Text("How to Stop:")
